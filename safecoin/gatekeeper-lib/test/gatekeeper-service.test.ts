...
import {Connection, Keypair, PublicKey, SystemProgram, Transaction, TransactionInstruction,} from "@safecoin/web3.js";
import {PROGRAM_ID} from "../src/util/constants";
import * as GatewayTs from "@j0nnyboi/safecoin-gateway-ts";
import {
  GatewayToken,
  GatewayTokenData,
  GatewayTokenState,
...
import {Active} from "@j0nnyboi/safecoin-gateway-ts/dist/lib/GatewayTokenData";
