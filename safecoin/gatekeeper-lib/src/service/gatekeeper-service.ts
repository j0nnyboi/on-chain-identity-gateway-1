import {Connection, Keypair, PublicKey, Transaction, TransactionInstruction,} from "@safecoin/web3.js";
import {
  findGatewayToken,
  freeze,
  GatewayToken,
...
import {safecoin_COMMITMENT} from "../util/constants";
...
export class GatekeeperService {
  ...
  private async optionsWithDefaults(
    ...
    const defaultOptions = {
      ...
      commitment: safecoin_COMMITMENT,
      ...this.config,
      ...options,
    };
