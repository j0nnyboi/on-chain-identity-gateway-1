import { Assignable, Enum, SCHEMA } from "./safecoinBorsh";
 ...
 *
 * Must match safecoin/program/src/instruction.rs
 */
 ...
 * Returns a safecoin instruction that must be signed by the gatekeeper network authority.
 *
 ...
 * Returns a safecoin instruction that must be signed by the gatekeeper authority.
