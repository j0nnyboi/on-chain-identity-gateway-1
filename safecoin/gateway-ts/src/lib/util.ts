...
// Based on safecoin/integration-lib/src/state.rs
 ...
 *
 * Warning - this uses the safecoin getProgramAccounts RPC endpoint, which is inefficient and may be
 * blocked by some RPC services.
 *
 * @param connection A safecoin connection object
 ...
 * @param commitment The safecoin commitment level at which to register gateway token changes. Defaults to 'confirmed'
...
export const onGatewayTokenChange = (
  ...
  commitment: Commitment = safecoin_COMMITMENT
): number => {
 ...
 * @param connection A safecoin connection
